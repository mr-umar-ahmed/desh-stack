    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          <div key={i} className="bg-card p-4 rounded-2xl border border-indigo/10 shadow-sm text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {myProducts.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="bg-card p-6 rounded-2xl border border-indigo/10 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow"
              >
                <div>
