    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; padding: 20px;">
          ...
          <br/>
          <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/dashboard" style="background-color: #4c5372; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">
            Go to Dashboard
          </a>
        </div>
      `,
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; padding: 20px;">
          ...
          <br/>
          <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/products/${productSlug}" style="background-color: #4c5372; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">
            View Your Product
          </a>
        </div>
      `,
